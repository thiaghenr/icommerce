...
<form name='form_caixa' id='form_caixa' action='caixa_controller.php' method='post'>
...
<table border="1" width="100%">
  ...
  <tr>
    <td>Total Creditos Clientes</td>
    <td>
      <?=formata($total_creditos)?>      <input type='hidden' name='vl_mov_creditos' id='vl_mov_creditos' value="<?=$total_creditos?>"/>    </td>
  </tr>
  <tr>
    <td>Total Devolucoes por cliente</td>
    <td>
      <?=formata($total_devolvidos_cl)?>      <input type='hidden' name='vl_mov_devolucao' id='vl_mov_devolucao' value="<?=$total_creditos?>"/>    </td>
  </tr>
  <tr>
    <td>Total Transferido ao Financeiro</td>
    <td>
      <?=formata($transferido)?>      <input type='hidden' name='vl_mov_transferido_fin' id='vl_transferido_fin' value="<?=$total_creditos?>"/>    </td>
  </tr>
  <tr>
