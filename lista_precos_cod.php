...
$this->Cell(0,5,"LISTADO DE PRECIOS",0,1,'C');
$this->Ln(8);
$this->SetY("30");
$this->SetX("20");
$this->Cell(172,0,'',1,1,'L');
...
//$pdf->Ln(1);
    ...
    $sql = "SELECT * FROM produtos GROUP BY Codigo,Codigo ORDER BY CODIGO ASC ";
...
$pdf->Cell(120,4,$reg_lista['Descricao'],0,0,'L');
$pdf->Cell(20,4,guarani($reg_lista['valor_a']),0,1,'R');
