 ...
 * 18 June  2008
 * Updated by Allison Vollmann (genus2200)
 * 08 April 2007
...
if(Ext.form.Field){
   Ext.form.Field.prototype.invalidText = "O valor para este campo  inv&aacute;lido";
}
...
if(Ext.form.TextField){
   Ext.apply(Ext.form.TextField.prototype, {
      minLengthText : "O tamanho m&iacute;nimo para este campo  {0}",
      maxLengthText : "O tamanho m&aacute;ximo para este campo  {0}",
      blankText     : "Este campo  obrigat&oacute;rio.",
      regexText     : "",
      emptyText     : null
   });
}
...
if(Ext.form.NumberField){
   Ext.apply(Ext.form.NumberField.prototype, {
      minText : "O valor m&iacute;nimo para este campo  {0}",
      maxText : "O valor m&aacute;ximo para este campo  {0}",
      nanText : "{0} n&atilde;o  um n&uacte;mero v&aacute;lido"
   });
}
...
if(Ext.form.DateField){
   Ext.apply(Ext.form.DateField.prototype, {
      ...
      invalidText       : "{0} n&atilde;o uma data v&aacute;lida - deve ser informado no formato {1}",
      format            : "d/m/Y"
   });
}
...
if(Ext.form.VTypes){
   Ext.apply(Ext.form.VTypes, {
      ...
      alphanumText : 'Este campo deve conter apenas letras, n&uacte;meros e _'
   });
}
