 		...
 		ds = new Ext.data.Store({
	        ...
	        cm: new xg.ColumnModel(
		        [
					...
					{id:'razao_social', width:150, header: "Razao Social", hidden: true,  sortable: true, dataIndex: 'razao_social'},
					...
					{id:'limite', width:90, header: "Limite", hidden: true,  sortable: true, dataIndex: 'limite'},
					...
					{id:'cidade', width:100, header: "Cidade", hidden: true,  sortable: true, dataIndex: 'cidade'}
        ...
        items: [{
            ...
            items:[{
                ...
                items: [
					...
					fireKey : function(e){//evento de tecla   
                            if(e.getKey() == e.ENTER) {//precionar enter   
							   document.getElementById('cedulacli').focus();
                            }}
                },
					{
                    xtype:'textfield',
...
//		baseParams:{acao: "listarContatos"},
		...
		sortInfo: {field: 'id', direction: 'DESC', id: Ext.getCmp("controle").getValue()},
		remoteSort: true		
	});
		...
		simple = new Ext.FormPanel({
			...
			items: [
					...
					fireKey: function(e,type){
					   if(e.getKey() == e.ENTER) {//precionar enter   
							var theQuery=Ext.get('query').getValue();
