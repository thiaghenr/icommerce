...
if($acao == 'FinPedido'){
	...
	$sql_add = "INSERT INTO pedido
					(controle_cli, nome_cli, sessao_car, data_car, total_nota, situacao, usuario_id, forma_pagamento_id, frete, vendedor_id, desconto)
					VALUES
					('$controle', '$nomecli', '".session_id()."', NOW(), '$total_carrinho', 'A', '$user', '$formaPgto', '$valor_frete', '$vendedor', '$desconto' )";
...
//	$total_carrinho = $total_carrinho - $desconto;
	...
	$sql_up_estoque_prod = "UPDATE produtos SET Estoque = round(Estoque - '$qtd_produto',2) WHERE id = '$idprod' ";
