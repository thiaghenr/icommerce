     ...
     gridLancCaixa = new Ext.grid.EditorGridPanel({
        ...
        columns: [
			...
			
            {
                ...
                width: 150,
                sortable: true,
                dataIndex: 'receita_id',
				fixed:true,
				renderer: formataReceita
            },
			{	
				id: 'dt_lancamento',
                header: "Lancamento",
...
storeLancCaixa.on('load', function(){
		...
		var TotalCaixa = parseFloat(Entradas) - parseFloat(Saidas) - parseFloat(Trf);
