...
/////// PAGARE //////////////////////////////
var imprimirPagare = function(){
var selectedKeys = grid_Pedidos.selModel.selections.keys; 
					if(selectedKeys.length > 0){	
								var selectedRows = grid_Pedidos.selModel.selections.items;
								var selectedKeys = grid_Pedidos.selModel.selections.keys; 
								function popup(){
window.open('../pagare.php?pedido='+selectedKeys +'','popup','width=750,height=500,scrolling=auto,top=0,left=0')
}
popup();
}
else{
...
function ListaProdutosAdd(){		
  ...
  FormGridPedidosEdit = new Ext.FormPanel({
