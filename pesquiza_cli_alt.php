<?
  ...
  //  $sql = "SELECT controle,nome,endereco,telefonecom FROM clientes limit 0,200";
    $sql = "SELECT * FROM clientes WHERE controle LIKE '%$cod%' AND nome LIKE '%$nom%'  ORDER BY nome asc limit 0,100";
...
<table width="49%" border="0">
  <tr>
    ...
    <td width="85%">
	<form name="nome" method="POST" action="lista_cli_result.php">
	<input type="text" size="40" name="nom" value="<?=$_SESSION['nomeCli']?>"></td>
  </tr></form>
</table>
  <table width="100%" border="0">
    <tr>
      <td bgcolor="#85C285"><div align="center">
          <p class="Estilo1 Estilo6"><bgcolor="#FFFFFF"><strong>Lista Geral Clientes</strong></p>
      </div></td>
    </tr>
  </table>
</div>
 ...
 if(lugar=='voltar'){
  ...
  window.location.href='http://';
	...
	<style>
		...
		#myGrid .aw-column-2 {width: 120px;}
