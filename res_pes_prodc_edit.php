...
*/   
    ...
    $sql = "SELECT * FROM produtos WHERE ((Descricao LIKE '%$desc%') AND (Codigo LIKE '$ref%')) OR ((part_number LIKE '%$ref%') AND (Descricao LIKE '%$desc%') ) OR ((cod_original LIKE '%$ref%') AND (Descricao LIKE '%$desc%')) OR ((Codigo_Fabricante LIKE '%$ref%') AND (Descricao LIKE '%$desc%'))  ORDER BY Descricao ASC limit 0,100 ";
	...
	<script type="text/javascript">
		...
		function getItemRow(grid, event){
			...
			if(key==13){
				...
				url = "cotizacion_edit.php?acao=add&";
