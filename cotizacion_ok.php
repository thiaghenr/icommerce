...
<title>Cotizacion Efectuada con exicto - <? echo $title ?></title>
...
<table border="0" width="100%">
   <tr>
     <td width="14%" bgcolor="#FFFFFF"><strong>OR&Ccedil;AMENTO N:</strong></td>
     <td width="45%" bgcolor="#FFFFFF"><?=$reg_lista['id']?></td>
 ...
 <table  border="1" bordercolor="#000000" style="border-collapse: collapse" width="100%">
	...
	$sql_list = "SELECT c.*, ic.*  FROM cotacao c, itens_cotacao ic WHERE c.id = '".$reg_lista['id']."' AND ic.id_cotacao = '".$reg_lista['id']."' ORDER BY referencia_prod ASC";
