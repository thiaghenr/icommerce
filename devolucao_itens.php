...
<table width="100%" border="0" bordercolor="#FF00FF">
  <tr>
    <td height="17" background="images/barra.jpg" bgcolor="#0EEAE0"><div align="center" class="Estilo1">
      <p class="Estilo6 style5">DEVOLUCAO DE ITENS</p>
    </div></td>
  </tr>
</table>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><form action="devolucao_itens.php" method="post" name="id" class="Estilo54" id="form1">
      <label>
      <input type="text" id="ped" name="ped" />
      </label>
    </form>    </td>
    <td><input type="submit" name="Submit" value="Buscar" /></td>
    <form action="devolucao_itens.php" method="post" name="id" class="Estilo54" id="form1">
    <td>&nbsp;</td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="1">
  ...
  <tr bgcolor="<? echo $cor?>"> 
    ...
    <td width="3%" class="transparent_class" ><a href="devolucao_itens_edit.php?ide=<?=$reg_lista['id']?>&estado=<?=$reg_lista['situacao']?>" class="Estilo47"><img src="images/cart_delete.png" width="18" height="14" border="0"/></a></td>
  </tr>
  <?
  $i++;
			}
