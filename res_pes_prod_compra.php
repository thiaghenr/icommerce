...
<table width="49%" border="0">
  <tr>
	...
	<td width="85%">
	<form name="Descricao" method="POST" action="res_pes_prod_compra.php">
...
function navegacao(lugar){
 if(lugar=='voltar'){
  ...
  window.location.href='entrada_produtos.php';
 }
 else if(lugar=='Curso'){
  window.location.href='http://';
	...
	<title>Productos - <? echo $title; ?></title>
	...
	<script>
		...
		var myColumns = [
			"Codigo", "Descripcion", "Disp", "Bloq", "Peco A", "PReco B", "Preco C" 
		];
...
*/
	obj.onKeyEnter = function(event){
        ...
        url = "entrada_produtos.php?acao=add&";
