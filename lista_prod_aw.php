<?
	...
	//$novovalor = $linha['Preco_Venda'] + 2 ;
		...
		$str_dados.="'".addslashes(number_format(($linha['valor_a']*$vl_cambio_guarani)))."',";
		$str_dados.="'".addslashes(number_format(($linha['valor_b']*$vl_cambio_guarani)))."',";
		$str_dados.="'".addslashes(number_format(($linha['valor_c']*$vl_cambio_guarani)))."'],";
    }
  ...
  <table width="100%" border="0">
    <tr>
      <td bgcolor="#FF0000"><div align="center">
          <p class="Estilo3 Estilo2 Estilo4">Listado Geral de Productos</p>
      </div></td>
    </tr>
  </table>
</div>
