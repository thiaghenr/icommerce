                ...
                //   keyup: this.onSearchKeyUp
							...
							store: {
								data: [
									...
									{ coluna: 'ItemName', title: 'Dddescripcion'}
								]
							}
							},
							{
                            ...
                            ui: 'confirm',
                            handler: function() {
								var pesquisa = Ext.ComponentQuery.query('#buscaprod')[0].getValue();
								var coluna =Ext.ComponentQuery.query('#coluna')[0].getValue();
								Ext.getStore('ProdutosStore').load(({params:{'query': pesquisa, 'coluna': coluna}}));
							}
							}							
