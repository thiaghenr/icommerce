...
$sql_lista = "SELECT ct.*, cl.endereco, cl.celular,cl.nome,cl.ruc, cl.telefone1 FROM pedido ct, entidades cl WHERE ct.id = '".$_GET['id_pedido']."' AND ct.controle_cli = cl.controle ";
...
$pdf->Cell(90,5,$reg_lista['ruc'],0,0,'L');
$pdf->Cell(15,5,"FONE:",0,0,'L');
$pdf->Cell(48,5,$reg_lista['telefone'],0,1,'L');
$pdf->Cell(28,5,"DIRECCION:",0,0,'L');
$pdf->Cell(48,5,$reg_lista['endereco'],0,1,'L');
$pdf->Ln(6);
...
$pdf->Cell(21,6,"CODIGO",1,0,'C');
$pdf->Cell(100,6,"DESCRIPTION DEL PRODUTO",1,0,'C');
...
$pdf->Cell(21,6,substr($reg_list['referencia_prod'],0,10),1,0,'L');
$pdf->SetFont('arial','',11);
$pdf->Cell(100,6,substr($reg_list['descricao_prod'],0,41),1,0,'L');
$pdf->SetFont('arial','b',11);
