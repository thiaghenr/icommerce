...
<title>Altercao Proveedor</title>
<style type="text/css">
<!--
.Estilo1 {
	color: #FFFFFF;
...
<table width="100%" border="0" bordercolor="#ECE9D8" bgcolor="#FF0000">
    <tr>
      <td height="22"><div align="center" class="Estilo1">Alteracion efectuada con exito </div></td>
    </tr>
</table>
  ...
  <table width="80%" height="46%" border="0">
  <tr>
    <td height="22" colspan="3" bgcolor="#CCCCCC"><strong>Proveedor</strong></td>
    <td width="31%" bgcolor="#CCCCCC"><strong>Fantasia</strong></td>
    <td width="30%" bgcolor="#CCCCCC"><strong>Fecha Catastro</strong></td>
  </tr>
  <tr bgcolor="#FFFFFF">
  ...
  <tr>
    <td height="23" colspan="3" bgcolor="#FFFFFF"><?=$reg_prod['endereco']?></td>
    <td height="23" bgcolor="#FFFFFF"><?=$reg_prod['bairro']?></td>
    <td bgcolor="#FFFFFF"><?=$reg_prod['dt_ult_compra']?></td>
  </tr>
  <tr>
    <td width="10%" height="23" bgcolor="#CCCCCC"><strong>DDD</strong></td>
    <td width="13%" height="23" bgcolor="#CCCCCC"><strong>Tel&eacute;fono</strong></td>
    <td width="16%" height="23" bgcolor="#CCCCCC"><strong>CEP</strong></td>
    <td height="23" bgcolor="#CCCCCC"><strong>Fax</strong></td>
    <td bgcolor="#CCCCCC"><strong>Cidade</strong></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td height="30"><?=$reg_prod['ddd']?></td>
    <td height="30"><?=$reg_prod['telefone']?></td>
    <td height="30"><?=$reg_prod['cep']?></td>
    <td><?=$reg_prod['fax']?></td>
  ...
  <tr>
    ...
    <td bgcolor="#CCCCCC"><strong>CGC</strong></td>
  </tr>
  <tr bgcolor="#FFFFFF">
...
<table width="38%" border="0">
  ...
  <tr>
    <td><form id="form1" name="form1" method="post" action="result_alt_prov.php">
      <input type="text" name="cod" id="cod" />
    </form></td>
    <td><form id="form2" name="form2" method="post" action="result_alt_prov.php">
